...
public final class VersionMethodReference {
  ...
  public static VersionMethodReference buildFrom(AnnotationNode annotationNode) {
    if (!DynRefTranslationConfiguration.className(annotationNode).equals(DynRefTranslationConfiguration.VERSION_METHOD_REFERENCE_ANNOTATION_PATH)) {
      throw new IllegalArgumentException("Invalid annotation type");
    }
    List<Object> values = annotationNode.values;
    Map<String, Object> annotationElementMap = DynRefTranslationConfiguration.buildAnnotationMap(values);
